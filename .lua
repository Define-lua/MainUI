...
do
	...
	local info = info or {}
        local name = info.name or info.Name or "Defineware.lua"
        local title = info.title or info.Title or "Defineware.lua"
        ...
        function window:Watermark(info)
            ...
            spawn(function()
                while wait(0.1) do
                    watermark_title.Text = string.format("Defineware.lua | Private Build | Ping : " .. tostring(library.shared.ping) .. "ms | FPS : " .. tostring(library.shared.fps), window.name)
